  ...
  return (
    <div>
      {!autenticado ? (
        ...
        <>
          <nav style={{ /* display: 'flex', */ justifyContent: 'center', alignItems: 'center', gap: '1.5rem', background: 'linear-gradient(90deg, #007bff 60%, #0056b3 100%)', padding: '1.2rem 0', marginBottom: '1rem', borderRadius: '16px 16px 16px 16px', boxShadow: '0 2px 8px rgba(0,0,0,0.08)' }}>
